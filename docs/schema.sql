...
CREATE INDEX IF NOT EXISTS idx_sake_records_owner_id ON sake_records(owner_id);
CREATE INDEX IF NOT EXISTS idx_sake_records_consumed_date ON sake_records(consumed_date DESC);
CREATE INDEX IF NOT EXISTS idx_sake_records_updated_at ON sake_records(updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_sake_records_drink_type ON sake_records(drink_type);
...
CREATE INDEX IF NOT EXISTS idx_sake_images_owner_id ON sake_images(owner_id);
CREATE INDEX IF NOT EXISTS idx_sake_images_record_id ON sake_images(record_id);
CREATE INDEX IF NOT EXISTS idx_sake_images_display_order ON sake_images(record_id, display_order);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_tags_default_unique
  ON tags(drink_type, tag_group, label)
  WHERE owner_id IS NULL;

CREATE UNIQUE INDEX IF NOT EXISTS idx_tags_owner_unique
  ON tags(owner_id, drink_type, tag_group, label)
  WHERE owner_id IS NOT NULL;

CREATE INDEX IF NOT EXISTS idx_tags_owner_id ON tags(owner_id);
CREATE INDEX IF NOT EXISTS idx_tags_drink_type_group ON tags(drink_type, tag_group);
