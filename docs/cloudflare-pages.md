...
운영 환경 변수, D1 schema 적용, 기본 사케 태그 seed 확인, R2 이미지 경로, Google
OAuth redirect URI, Pages/Workers 프로젝트 구분, 디버그 API 노출 기준은
[운영 설정과 디버그 노출 체크리스트](operations-checklist.md)를 기준으로 확인합니다.
